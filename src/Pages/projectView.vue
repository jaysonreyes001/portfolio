<template lang="">
     <section class="min-h-[100dvh] mt-[180px] md:mt-[120px] app-size">
          <div class="flex items-center">
               ...
               <nav class="flex md:ml-10 ml-7" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                         <li class="text-gray-600 dark:text-gray-200">
                              <div class="flex items-center space-x-1.5">
                              <a href="#" class="text-sm md:text-lg inline-flex items-center font-medium text-body hover:text-fg-brand">Projects</a>
                              </div>
                         </li>
